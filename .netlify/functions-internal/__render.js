...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-d77b433a.js",
      css: [assets + "/_app/assets/start-d5b4de3e.css"],
      js: [assets + "/_app/start-d77b433a.js", assets + "/_app/chunks/vendor-bcb894db.js", assets + "/_app/chunks/preload-helper-ec9aa979.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-dd15d616.js", "css": ["assets/pages/__layout.svelte-f883e1b0.css"], "js": ["pages/__layout.svelte-dd15d616.js", "chunks/vendor-bcb894db.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-59ba3a18.js", "css": [], "js": ["error.svelte-59ba3a18.js", "chunks/vendor-bcb894db.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-1449fbdc.js", "css": ["assets/pages/index.svelte-62e9c7b8.css"], "js": ["pages/index.svelte-1449fbdc.js", "chunks/vendor-bcb894db.js"], "styles": [] }, "src/routes/what-we-do.svelte": { "entry": "pages/what-we-do.svelte-2517e5b3.js", "css": [], "js": ["pages/what-we-do.svelte-2517e5b3.js", "chunks/vendor-bcb894db.js", "chunks/preload-helper-ec9aa979.js"], "styles": [] } };
...
var Menu_item = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.id === void 0 && $$bindings.id && id !== void 0)
    $$bindings.id(id);
  return `<div><div class="${"px-16"}"><a class="${"hover:text-primary-main"}"${add_attribute("href", url, 0)}>${escape(label)}</a></div>
  <div${add_attribute("id", id, 0)} class="${"h-8 w-full"}"></div></div>`;
});
var css$5 = {
  code: ".svelte-1kk9iex{overflow:hidden}#wrapper.svelte-1kk9iex{position:fixed;left:0;top:0;z-index:100}",
  map: '{"version":3,"file":"navbar.svelte","sources":["navbar.svelte"],"sourcesContent":["<script>\\n  import MenuItem from \\"./menu-item.svelte\\";\\n\\n  let label1 = \\"who-we-are\\";\\n  let label2 = \\"what-we-do\\";\\n  let label3 = \\"leadership\\";\\n  let label4 = \\"news\\";\\n  let label5 = \\"contact\\";\\n<\/script>\\n\\n<div\\n  id=\\"wrapper\\"\\n  class=\\"w-full xl:px-148 lg:px-96 md:px-72 h-72 bg-on-background-variant-alpha\\"\\n>\\n  <nav class=\\"flex py-16 xl:text-lg lg:text-lg md:text-md\\">\\n    <div class=\\"flex-grow\\">\\n      <a class=\\"\\" href=\\"/\\">\\n        <img src=\\"assets/logo.png\\" alt=\\"Renue Logo\\" class=\\"w-200\\" />\\n      </a>\\n    </div>\\n    <div class=\\"flex items-center xl:space-x-32 lg:space-x-32\\">\\n      <MenuItem label=\\"Who We Are\\" url={\\"/\\" + label1} id={label1} />\\n      <MenuItem label=\\"What We Do\\" url={\\"/\\" + label2} id={label2} />\\n      <MenuItem label=\\"Leadership\\" url={\\"/\\" + label3} id={label3} />\\n      <MenuItem label=\\"News\\" url={\\"/\\" + label4} id={label4} />\\n      <MenuItem label=\\"Contact\\" url={\\"/\\" + label5} id={label5} />\\n    </div>\\n  </nav>\\n</div>\\n\\n<style>\\n  * {\\n    overflow: hidden;\\n  }\\n  #wrapper {\\n    position: fixed;\\n    left: 0;\\n    top: 0;\\n    z-index: 100;\\n  }\\n</style>\\n"],"names":[],"mappings":"AA+BE,eAAE,CAAC,AACD,QAAQ,CAAE,MAAM,AAClB,CAAC,AACD,QAAQ,eAAC,CAAC,AACR,QAAQ,CAAE,KAAK,CACf,IAAI,CAAE,CAAC,CACP,GAAG,CAAE,CAAC,CACN,OAAO,CAAE,GAAG,AACd,CAAC"}'
};
var label1 = "who-we-are";
var label2 = "what-we-do";
var label3 = "leadership";
var label4 = "news";
var label5 = "contact";
var Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$5);
  return `<div id="${"wrapper"}" class="${"w-full xl:px-148 lg:px-96 md:px-72 h-72 bg-on-background-variant-alpha svelte-1kk9iex"}"><nav class="${"flex py-16 xl:text-lg lg:text-lg md:text-md svelte-1kk9iex"}"><div class="${"flex-grow svelte-1kk9iex"}"><a class="${" svelte-1kk9iex"}" href="${"/"}"><img src="${"assets/logo.png"}" alt="${"Renue Logo"}" class="${"w-200 svelte-1kk9iex"}"></a></div>
    <div class="${"flex items-center xl:space-x-32 lg:space-x-32 svelte-1kk9iex"}">${validate_component(Menu_item, "MenuItem").$$render($$result, {
    label: "Who We Are",
    url: "/" + label1,
    id: label1
  }, {}, {})}
      ${validate_component(Menu_item, "MenuItem").$$render($$result, {
    label: "What We Do",
    url: "/" + label2,
    id: label2
  }, {}, {})}
...
var cms_url = readable("https://renue-web-app.prismic.io/api/v2");
var css$3 = {
  code: "div.svelte-hxax12{background:linear-gradient(to right, #a6cf4d, #00bcea)}",
  map: '{"version":3,"file":"spacer-line.svelte","sources":["spacer-line.svelte"],"sourcesContent":["<div class=\\"h-24 w-full\\" />\\n\\n<style>\\n  div {\\n    background: linear-gradient(to right, #a6cf4d, #00bcea);\\n  }\\n</style>\\n"],"names":[],"mappings":"AAGE,GAAG,cAAC,CAAC,AACH,UAAU,CAAE,gBAAgB,EAAE,CAAC,KAAK,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,AACzD,CAAC"}'
};
var Spacer_line = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$3);
  return `<div class="${"h-24 w-full svelte-hxax12"}"></div>`;
});
var Lg_primary_fill = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<button class="${"w-240 h-72 text-lg font-bold rounded-md bg-primary-main hover:bg-secondary-main px-32"}">Get Started
</button>`;
});
var css$2 = {
  code: '.svelte-14mqiq0{overflow:hidden}#wrapper.svelte-14mqiq0{position:relative;z-index:1;min-height:800px;margin:auto;background-image:url("https://media.istockphoto.com/photos/stainless-steel-pipes-and-pipelines-in-modern-beer-factory-brewery-picture-id1152495926");background-repeat:no-repeat;background-size:cover}#gradient.svelte-14mqiq0{position:absolute;margin:auto;left:0;top:0;min-height:800px;width:100%;z-index:-10;background:linear-gradient(to bottom, #0f1011de, rgba(53, 53, 53, 0.541))}#contents.svelte-14mqiq0{position:absolute;z-index:10}',
  map: '{"version":3,"file":"hero-primary.svelte","sources":["hero-primary.svelte"],"sourcesContent":["<script>\\n  import Button from \\"../buttons/lg-primary-fill.svelte\\";\\n  export let heading, subheading, paragraph;\\n\\n  let splitted = subheading.split(\\"%%\\");\\n  // console.log(\\"splitted\\", splitted);\\n<\/script>\\n\\n<div id=\\"wrapper\\">\\n  <div id=\\"gradient\\">\\n    <div\\n      id=\\"contents\\"\\n      class=\\"text-on-background-variant pt-168 xl:px-148 lg:px-96 md:px-72\\"\\n    >\\n      <h1 class=\\"text-4xl font-bold leading-4xl\\">\\n        {heading}\\n      </h1>\\n      <h2 class=\\"text-4xl mt-16 font-bold leading-6xl\\">\\n        {splitted[0]}<span class=\\"text-primary-main\\">{splitted[1]}</span\\n        >{splitted[2]}\\n      </h2>\\n      <h2 class=\\"text-lg leading-md mt-56 xl:max-w-lg md:max-w-lg\\">\\n        {paragraph}\\n      </h2>\\n      <div class=\\"mt-56\\">\\n        <Button />\\n      </div>\\n    </div>\\n  </div>\\n</div>\\n\\n<style>\\n  * {\\n    overflow: hidden;\\n  }\\n  #wrapper {\\n    position: relative;\\n    z-index: 1;\\n    min-height: 800px;\\n    margin: auto;\\n    background-image: url(\\"https://media.istockphoto.com/photos/stainless-steel-pipes-and-pipelines-in-modern-beer-factory-brewery-picture-id1152495926\\");\\n    background-repeat: no-repeat;\\n    background-size: cover;\\n  }\\n\\n  #gradient {\\n    position: absolute;\\n    margin: auto;\\n    left: 0;\\n    top: 0;\\n    min-height: 800px;\\n    width: 100%;\\n    z-index: -10;\\n    background: linear-gradient(to bottom, #0f1011de, rgba(53, 53, 53, 0.541));\\n  }\\n\\n  #contents {\\n    position: absolute;\\n    z-index: 10;\\n  }\\n</style>\\n"],"names":[],"mappings":"AAgCE,eAAE,CAAC,AACD,QAAQ,CAAE,MAAM,AAClB,CAAC,AACD,QAAQ,eAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,IAAI,CACZ,gBAAgB,CAAE,IAAI,8HAA8H,CAAC,CACrJ,iBAAiB,CAAE,SAAS,CAC5B,eAAe,CAAE,KAAK,AACxB,CAAC,AAED,SAAS,eAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,IAAI,CAAE,CAAC,CACP,GAAG,CAAE,CAAC,CACN,UAAU,CAAE,KAAK,CACjB,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,GAAG,CACZ,UAAU,CAAE,gBAAgB,EAAE,CAAC,MAAM,CAAC,CAAC,SAAS,CAAC,CAAC,KAAK,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,KAAK,CAAC,CAAC,AAC5E,CAAC,AAED,SAAS,eAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,AACb,CAAC"}'
};
var Hero_primary = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="${"wrapper"}" class="${"svelte-14mqiq0"}"><div id="${"gradient"}" class="${"svelte-14mqiq0"}"><div id="${"contents"}" class="${"text-on-background-variant pt-168 xl:px-148 lg:px-96 md:px-72 svelte-14mqiq0"}"><h1 class="${"text-4xl font-bold leading-4xl svelte-14mqiq0"}">${escape(heading)}</h1>
      <h2 class="${"text-4xl mt-16 font-bold leading-6xl svelte-14mqiq0"}">${escape(splitted[0])}<span class="${"text-primary-main svelte-14mqiq0"}">${escape(splitted[1])}</span>${escape(splitted[2])}</h2>
      <h2 class="${"text-lg leading-md mt-56 xl:max-w-lg md:max-w-lg svelte-14mqiq0"}">${escape(paragraph)}</h2>
      <div class="${"mt-56 svelte-14mqiq0"}">${validate_component(Lg_primary_fill, "Button").$$render($$result, {}, {}, {})}</div></div></div>
</div>`;
});
...
var css = {
  code: ".svelte-igyjjv{overflow:hidden}",
  map: '{"version":3,"file":"carousel.svelte","sources":["carousel.svelte"],"sourcesContent":["<script>\\n  import { Swiper, SwiperSlide } from \\"swiper/svelte\\";\\n\\n  // Import Swiper styles\\n  import \\"swiper/css\\";\\n\\n  import \\"swiper/css/pagination\\";\\n  import \\"swiper/css/navigation\\";\\n\\n  import \\"./style.css\\";\\n\\n  // import Swiper core and required modules\\n  import SwiperCore, { Keyboard, Pagination, Navigation } from \\"swiper\\";\\n\\n  // install Swiper modules\\n  SwiperCore.use([Keyboard, Pagination, Navigation]);\\n<\/script>\\n\\n<Swiper\\n  spaceBetween={30}\\n  navigation={true}\\n  pagination={{\\n    clickable: true,\\n  }}\\n>\\n  <SwiperSlide\\n    ><div\\n      class=\\"flex text-left justify-center items-center xl:text-2xl lg:text-xl md:text-xl sm:text-xl px-56\\"\\n    >\\n      <h1 class=\\"xl:w-960 lg:w-800 md:w-1600 px-56\\">\\n        Flux has dropped in price to the point where companies are having to\\n        depose of it as a waste.\\n      </h1>\\n      <img\\n        class=\\"xl:w-400 lg:w-400 md:w-800\\"\\n        src=\\"https://store.womostore.com/media/catalog/product/cache/0/image/9df78eab33525d08d6e5fb8d27136e95/w/o/womo_WX001040130048H_terziario_1.png\\"\\n        alt=\\"\\"\\n      />\\n    </div>\\n  </SwiperSlide>\\n  <SwiperSlide>\\n    <img src=\\"https://swiperjs.com/demos/images/nature-2.jpg\\" />\\n  </SwiperSlide>\\n</Swiper>\\n\\n<!-- \\n<div class=\\"flex w-full h-400 items-center justify-center px-32\\">\\n  <div class=\\"xl:w-48 lg:w-56 md:w-120 sm:w-96\\">\\n    <img\\n      on:mouseenter={handleEnterLeft}\\n      on:mouseleave={handleLeaveLeft}\\n      id=\\"chevronLeft\\"\\n      src=\\"/assets/icons/chevron-left.svg\\"\\n      alt=\\"\\"\\n    />\\n  </div>\\n  <div\\n    class=\\"flex text-left items-center xl:text-2xl lg:text-xl md:text-xl sm:text-xl px-56\\"\\n  >\\n    <h1 class=\\"xl:w-960 lg:w-800 md:w-1600 px-56\\">\\n      Flux has dropped in price to the point where companies are having to\\n      depose of it as a waste.\\n    </h1>\\n    <img\\n      class=\\"xl:w-400 lg:w-400 md:w-800\\"\\n      src=\\"https://store.womostore.com/media/catalog/product/cache/0/image/9df78eab33525d08d6e5fb8d27136e95/w/o/womo_WX001040130048H_terziario_1.png\\"\\n      alt=\\"\\"\\n    />\\n  </div>\\n  <div class=\\"h-full xl:w-72 lg:w-56 md:w-120 sm:w-96\\">\\n    <img\\n      id=\\"chevronRight\\"\\n      src=\\"/assets/icons/chevron-right.svg\\"\\n      on:mouseenter={handleEnterRight}\\n      on:mouseleave={handleLeaveRight}\\n      alt=\\"\\"\\n    />\\n  </div>\\n</div>\\n<div class=\\"flex justify-center w-full space-x-12 mt-64\\">\\n  <span class=\\"dot bg-primary-main\\" />\\n  <span class=\\"dot bg-secondary-main\\" />\\n  <span class=\\"dot bg-primary-main\\" />\\n</div> -->\\n<style>\\n  * {\\n    overflow: hidden;\\n  }\\n\\n  .dot {\\n    height: 20px;\\n    width: 20px;\\n    border-radius: 50%;\\n    display: inline-block;\\n  }\\n\\n  #chevronRight {\\n    cursor: pointer;\\n  }\\n\\n  #chevronLeft {\\n    cursor: pointer;\\n  }\\n</style>\\n"],"names":[],"mappings":"AAqFE,cAAE,CAAC,AACD,QAAQ,CAAE,MAAM,AAClB,CAAC"}'
};
var Carousel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  Swiper$1.use([Keyboard, Pagination, Navigation]);
  $$result.css.add(css);
  return `${validate_component(Swiper, "Swiper").$$render($$result, {
    ...
    default: () => `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<div class="${"flex text-left justify-center items-center xl:text-2xl lg:text-xl md:text-xl sm:text-xl px-56 svelte-igyjjv"}"><h1 class="${"xl:w-960 lg:w-800 md:w-1600 px-56 svelte-igyjjv"}">Flux has dropped in price to the point where companies are having to
        depose of it as a waste.
      </h1>
      <img class="${"xl:w-400 lg:w-400 md:w-800 svelte-igyjjv"}" src="${"https://store.womostore.com/media/catalog/product/cache/0/image/9df78eab33525d08d6e5fb8d27136e95/w/o/womo_WX001040130048H_terziario_1.png"}" alt="${""}"></div>`
    })}
  ${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
      default: () => `<img src="${"https://swiperjs.com/demos/images/nature-2.jpg"}" class="${"svelte-igyjjv"}">`
    })}`
  })}
...
var Section_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"bg-background-light w-full h-6400 py-120"}">${validate_component(Carousel, "Carousel").$$render($$result, {}, {}, {})}</div>`;
});
var Section_2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"w-full h-640"}"><div class="${"px-148 py-120 text"}"><h1>title</h1></div></div>`;
});
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const fetchData = async (cms_url2, callback) => {
    ...
    console.log(data);
    let sections = [];
    await data.results.map((data2, index2) => {
      data2.data.body.forEach((section) => {
      ...
      let cleanData = {
        ...
        hero: {
          id: data2.id,
          uid: data2.uid,
          image_url: data2.data.body[0].primary["bg-image"].url,
          slice_type: data2.data.body[0].slice_type,
          button_label: data2.data.body[0].primary.button_label,
          heading: data2.data.body[0].primary.heading[0].text,
          subheading: data2.data.body[0].primary.subheading[0].text,
          paragraph: data2.data.body[0].primary.paragraph[0].text
        }
      };
...
`;
    ...
    return function(data) {
      return `
  ${data !== void 0 ? `${validate_component(Hero_section, "HeroSection").$$render($$result, { contents: data.hero }, {}, {})}` : ``}
`;
    }(__value);
  }(heroData)}
${validate_component(Section_1, "Section1").$$render($$result, {}, {}, {})}
${validate_component(Spacer_line, "SpacerLine").$$render($$result, {}, {}, {})}
${validate_component(Section_2, "Section2").$$render($$result, {}, {}, {})}
${validate_component(Section_3, "Section3").$$render($$result, {}, {}, {})}`;
});
...
var What_we_do = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Threejs_viewer, "ThreejsViewer").$$render($$result, {}, {}, {})}`;
});
